          ...
          <form className="space-y-4" action="#" method="post">
            ...
            <div>
              ...
              <select
                ...
                name="helpTopic"
                defaultValue="Select"
                className="h-11 w-full appearance-none rounded-[7px] border border-[#242b2d] bg-[#0b0f11] px-4 text-[14px] text-[#8f999f] outline-none transition focus:border-[#26ceb5]"
              >
            ...
            <button
              type="submit"
              className="mt-2 flex h-11 w-full items-center justify-center gap-2 rounded-[8px] bg-[#20d0bb] text-[15px] font-semibold text-[#e9ffff] transition hover:bg-[#1cc3af]"
            >
              Lets Connect
